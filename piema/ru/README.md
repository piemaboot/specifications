...
Версия   | Сигнатура                             | Рекмоендуется
-------- | ------------------------------------- | -------------
...
Название поля   | Тип           | Длина, байты | Метод хранения                         | Описание
--------------- | ------------- | ------------ | -------------------------------------- | ----------------------------------------------
**uuid**        | `UUID`        | 16           | UUID 4-ой версии                       | UUID записи
**template**    | `UUID`        | 16           | UUID 4-ой версии                       | UUID записи-шаблона
**name**        | `String`      |              | UTF-8 строка + `\x00`                  | Название записи
**comment**     | `String`      |              | UTF-8 строка + `\x00`                  | Комментарий (описание) к записи
**icon**        | `UUID`        | 16           | UUID 4-ой версии                       | UUID иконки записи
